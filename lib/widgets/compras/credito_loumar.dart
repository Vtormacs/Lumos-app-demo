...
class CreditoLoumar extends StatelessWidget {
  const CreditoLoumar({super.key});
        ...
        children: [
          Column(
            ...
            children: [
              ...
              const Text(
                "lorem ipsum dolor sit amet consectetur. Donec adipiscing pretium lorem quis.",
                style: TextStyle(
                  fontFamily: 'Manrope',
          ...
          Column(
            ...
            children: [
              const Text(
                "Como adquiro e utilizo meu Crédito Loumar?",
                style: TextStyle(
                  fontFamily: 'Manrope',
                  fontWeight: FontWeight.w600,
                  fontSize: 14,
          ...
          TextButton(
            onPressed: () async {
              final Uri whatsappUrl = Uri.parse(
                'https://wa.me/554535214001?text=Olá,%20preciso%20falar%20com%20um%20especialista%20sobre%20meus%20créditos%20Loumar!',
              );
